...
('hero_image', 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?auto=format&fit=crop&w=1000&q=80'),
('hero_badge_title', 'Handcrafted Cashmere Coat'),
...
('nf-001', 'Sovereign Oversized Cashmere Coat', 'Outerwear', 245000.00, NULL, 'New Arrival', 'gold', 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?auto=format&fit=crop&w=800&q=80', 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=800&q=80', '["#18181A", "#5C5449", "#E6E0D4"]', 'Meticulously tailored from double-faced cashmere. Features a structured lapel, concealed horn buttons, and an elegant waist sash.', '100% Double-Faced Cashmere. Lining: 100% Pure Silk.', '["XS", "S", "M", "L"]'),
('nf-002', 'Royal Silk Tailored Blazer', 'Tailoring', 185000.00, 210000.00, 'Limited Edition', 'dark', 'https://images.unsplash.com/photo-1490481651871-ab68de25d43d?auto=format&fit=crop&w=800&q=80', 'https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&w=800&q=80', '["#0D0D0E", "#C2A661"]', 'Single-breasted architectural jacket styled with padded shoulders and handcrafted silk-covered buttons for a modern silhouette.', '70% Heavy Silk, 30% Fine Wool.', '["S", "M", "L", "XL"]'),
('nf-003', 'Sculptural Leather Handbag', 'Leather Goods', 168000.00, NULL, 'Best Seller', 'gold', 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?auto=format&fit=crop&w=800&q=80', 'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?auto=format&fit=crop&w=800&q=80', '["#1A1816", "#7C6752"]', 'Handcrafted from full-grain leather with a smooth matte finish. Features brushed brass hardware and an inner suede pouch.', '100% Full-Grain Genuine Leather.', '["One Size"]'),
('nf-004', 'Bespoke Wool Pleated Trousers', 'Tailoring', 92000.00, NULL, 'Essential', 'dark', 'https://images.unsplash.com/photo-1509631179647-0177331693ae?auto=format&fit=crop&w=800&q=80', 'https://images.unsplash.com/photo-1554412933-514a83d2f3c8?auto=format&fit=crop&w=800&q=80', '["#18181A", "#9B958B"]', 'High-waisted trousers engineered with crisp forward deep pleats and wide leg profile for fluid motion and timeless comfort.', '100% Fine Merino Wool.', '["XS", "S", "M", "L", "XL"]'),
('nf-005', 'Midnight Silk Evening Gown', 'Tailoring', 145000.00, NULL, 'New Season', 'gold', 'https://images.unsplash.com/photo-1566174053879-31528523f8ae?auto=format&fit=crop&w=800&q=80', 'https://images.unsplash.com/photo-1518895949257-7621c3c786d7?auto=format&fit=crop&w=800&q=80', '["#0D0D0E", "#EAE6DF"]', 'Floor-sweeping bias-cut silk dress featuring delicate adjustable shoulder straps and a low cowl open back.', '100% Mulberry Silk Crepe.', '["XS", "S", "M", "L"]'),
('nf-006', 'Handcrafted Leather Ankle Boots', 'Footwear', 125000.00, 140000.00, 'Popular', 'dark', 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?auto=format&fit=crop&w=800&q=80', 'https://images.unsplash.com/photo-1535043934128-cf0b28d52f95?auto=format&fit=crop&w=800&q=80', '["#18181A"]', 'Handcrafted leather boot with a durable rubber sole, subtle debossed logo, and flexible side elastic gussets.', '100% Genuine Leather & Rubber Sole.', '["38", "39", "40", "41", "42", "43", "44"]'),
('nf-007', 'Heritage Hammered Gold Cuff', 'Fine Accessories', 68000.00, NULL, 'Signature', 'gold', 'https://images.unsplash.com/photo-1611591475143-4f8a77391851?auto=format&fit=crop&w=800&q=80', 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?auto=format&fit=crop&w=800&q=80', '["#C2A661"]', 'Hand-hammered 18k gold-plated brass cuff with organic sculpted edges and engraved brand logo.', '18k Gold Plated Recycled Brass.', '["S/M", "M/L"]'),
('nf-008', 'Imperial Silk & Velvet Agbada Coat', 'Outerwear', 320000.00, NULL, 'Luxury Edition', 'gold', 'https://images.unsplash.com/photo-1544441893-675973e31985?auto=format&fit=crop&w=800&q=80', 'https://images.unsplash.com/photo-1551028719-00167b16eac5?auto=format&fit=crop&w=800&q=80', '["#5C4D3C", "#18181A"]', 'Ultra-luxurious plush velvet statement coat featuring detailed embroidery lapels and a refined inner silk lining.', '100% Premium Velvet & Silk Accent.', '["S", "M", "L", "XL"]')
ON DUPLICATE KEY UPDATE `id`=`id`;
